...
var catalogs = map[Lang]map[string]string{
	ES: {
		...
		"board.by_status": "Por estado", "board.by_priority": "Por prioridad",
		...
		"stage.pendiente": "Pendiente", "stage.en_curso": "En curso", "stage.hecha": "Hecha", "stage.bloqueada": "Bloqueada",
	...
	EN: {
		...
		"board.by_status": "By status", "board.by_priority": "By priority",
		...
		"stage.pendiente": "Pending", "stage.en_curso": "In progress", "stage.hecha": "Done", "stage.bloqueada": "Blocked",
	...
	PT: {
		...
		"board.by_status": "Por status", "board.by_priority": "Por prioridade",
		...
		"vis.interno": "Interno", "vis.cliente": "Cliente", "vis.sistema": "Sistema",
		"stage.pendiente": "Pendente", "stage.en_curso": "Em andamento", "stage.hecha": "Concluída", "stage.bloqueada": "Bloqueada",
